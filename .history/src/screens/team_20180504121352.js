  ...
  render() {
    ...
    return (
      <View>
        ...
        <Button title='Créer une team' onPress={() => this.props.navigation.navigate('BabyList', { state: this.state })} />
        <Button title='Rejoindre une team' onPress={() => this.props.navigation.navigate('Message', { state: this.state })} />
